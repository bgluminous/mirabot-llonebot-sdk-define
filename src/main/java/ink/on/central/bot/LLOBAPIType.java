...
public enum LLOBAPIType {
  ...
  public enum File {
    ...
    GET_GROUP_FILE_SYSTEM_INFO("get_group_file_system_info", LLOBSendFileGroupGetSystemInfo.class, LLOBResFileGroupGetSystemInfo.class),
    /** 获取群根目录文件列表 LLOneBot扩展 */
    GET_GROUP_ROOT_FILES("get_group_root_files", LLOBSendFileGroupGetRoot.class, LLOBResGroupGetRootFiles.class),
    ...
    File(String apiUrl, Class<?> reqEntityClass, Class<?> resEntityClass) {
      this.apiUrl = apiUrl;
    ...
    @NotNull
    public static File urlOf(@NotNull String apiUrl) {
      for (File mapper : File.values()) {
  ...
  public enum Friend {
    ...
    Friend(String apiUrl, Class<?> reqEntityClass, Class<?> resEntityClass) {
      this.apiUrl = apiUrl;
      this.reqEntityClass = reqEntityClass;
      this.resEntityClass = resEntityClass;
    }
    ...
    @NotNull
    public static LLOBAPIType.Friend urlOf(@NotNull String apiUrl) {
      for (Friend mapper : Friend.values()) {
        if (mapper.getApiUrl().equals(apiUrl)) {
          return mapper;
        }
      }
  ...
  public enum Group {
    ...
    Group(String apiUrl, Class<?> reqEntityClass, Class<?> resEntityClass) {
      this.apiUrl = apiUrl;
      this.reqEntityClass = reqEntityClass;
      this.resEntityClass = resEntityClass;
    }
    ...
    @NotNull
    public static Group urlOf(@NotNull String apiUrl) {
      for (Group mapper : Group.values()) {
        if (mapper.getApiUrl().equals(apiUrl)) {
          return mapper;
        }
      }
  ...
  public enum Msg {
    ...
    Msg(String apiUrl, Class<?> reqEntityClass, Class<?> resEntityClass) {
      this.apiUrl = apiUrl;
      this.reqEntityClass = reqEntityClass;
      this.resEntityClass = resEntityClass;
    }
    ...
    @NotNull
    public static Msg urlOf(@NotNull String apiUrl) {
      for (Msg mapper : Msg.values()) {
        if (mapper.getApiUrl().equals(apiUrl)) {
          return mapper;
        }
      }
  ...
  public enum Other {
    ...
    Other(String apiUrl, Class<?> reqEntityClass, Class<?> resEntityClass) {
      this.apiUrl = apiUrl;
      this.reqEntityClass = reqEntityClass;
      this.resEntityClass = resEntityClass;
    }
    ...
    @NotNull
    public static Other urlOf(@NotNull String apiUrl) {
      for (Other mapper : Other.values()) {
        if (mapper.getApiUrl().equals(apiUrl)) {
          return mapper;
        }
      }
  ...
  public enum System {
    ...
    System(String apiUrl, Class<?> reqEntityClass, Class<?> resEntityClass) {
      this.apiUrl = apiUrl;
      this.reqEntityClass = reqEntityClass;
      this.resEntityClass = resEntityClass;
    }
    ...
    @NotNull
    public static System urlOf(@NotNull String apiUrl) {
      for (System mapper : System.values()) {
        if (mapper.getApiUrl().equals(apiUrl)) {
          return mapper;
        }
      }
  ...
  public enum Unclassified {
    ...
    Unclassified(String apiUrl, Class<?> reqEntityClass, Class<?> resEntityClass) {
      this.apiUrl = apiUrl;
      this.reqEntityClass = reqEntityClass;
      this.resEntityClass = resEntityClass;
    }
    ...
    @NotNull
    public static Unclassified urlOf(@NotNull String apiUrl) {
      for (Unclassified mapper : Unclassified.values()) {
        if (mapper.getApiUrl().equals(apiUrl)) {
          return mapper;
        }
      }
